...
/* twp: Calculate_checksum actions. */
...
/*twp: encode_CALCULATE_CHECKSUM.
 *
 *  encode ofpact_calculate_checksum into ofp10_action_calculate_checksum.
 *  */
static void
